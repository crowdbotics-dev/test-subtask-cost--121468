"""
Django settings for test_subtask_cost__121468 project.
...
ROOT_URLCONF = 'test_subtask_cost__121468.urls'
...
WSGI_APPLICATION = 'test_subtask_cost__121468.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_subtask_cost__121468 API",
    "DESCRIPTION": "API documentation for test_subtask_cost__121468 App",
    "VERSION": "v1",
}
