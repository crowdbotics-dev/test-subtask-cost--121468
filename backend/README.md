...
## Project Structure
    ...
    ├── test_subtask_cost__121468  # Django project configurations
...
1. Clone this repo and `cd test_subtask_cost__121468`
...
2. Clone this repo and `cd test_subtask_cost__121468`
